...
mobf_rabbit.rabbit_snow  = mobf_rabbit.get_rabbit_prototype( "snow_rabbit",  "Snow rabbit (Animals)", "mobf_rabbit_white.png" );
minetest.log("action","\tadding "..mobf_rabbit.rabbit_snow.name)
mobf_add_mob(mobf_rabbit.rabbit_snow)

mobf_rabbit.rabbit_grey  = mobf_rabbit.get_rabbit_prototype( "grey_rabbit",  "Grey Rabbit (Animals)", "mobf_rabbit_grey.png" );
minetest.log("action","\tadding "..mobf_rabbit.rabbit_grey.name)
mobf_add_mob(mobf_rabbit.rabbit_grey)

mobf_rabbit.rabbit_brown = mobf_rabbit.get_rabbit_prototype( "brown_rabbit", "Rabbit (Animals)",      "mobf_rabbit_brown.png" );
